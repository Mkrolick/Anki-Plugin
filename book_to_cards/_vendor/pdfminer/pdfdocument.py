...
# Crypto is optional: only required for AES-encrypted PDFs. Stubbed when
# the cryptography library isn't bundled so the rest of pdfminer keeps
# working on plain PDFs.
try:
